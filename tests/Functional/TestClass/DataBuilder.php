...
class DataBuilder implements ResolverInterface
{
    ...
    public static function getHuman(int $id)
    {
        ...
        return new Human($id, $humanData['name'], $humanData['height'], $humanData['mass'], $humanData['friends'], $episodes, $starShips);
    }
    ...
    public static function getStarShip(int $id)
    {
        ...
        return new StarShip($id, $shipData['name'], $shipData['name']);
    }
    ...
    public function getRoot($name)
    {
        switch ($name) {
            case 'hero':
                return [
                    self::getCharacter(1000),
                    self::getCharacter(2001),
                ];
        }
    }
}